<?php //to use wp udpate plugin
    ...
    if (!$menu_exists) {
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Home', 'dental-insight'),
      ...
      $parent_page_item_id = wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Pages', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Left Sidebar', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Right Sidebar', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('About Us', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Services', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Team', 'dental-insight'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Contact', 'dental-insight'),
    ...
    for($i=1;$i<=4;$i++){
      ...
      $dental_insight_post_image_url = get_template_directory_uri().'/assets/images/header-img.png';

      $dental_insight_image_name = 'header-img.png';
    ...
    set_theme_mod( 'dental_insight_services_section_title', 'OUR SERVICES' ); 
    ...
    $dental_insight_service_icon=array('fas fa-teeth','fas fa-teeth-open','fas fa-tooth','fas fa-teeth-open','fas fa-tooth','fas fa-teeth');
