 ...
 * Control - Switch.
 *
 * @package Dental Insight Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Dental_Insight_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'dental-insight-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'dental-insight-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
