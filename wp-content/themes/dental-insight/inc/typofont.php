...
function dental_insight_custom_styles($custom) {
	...
	wp_add_inline_style( 'dental-insight-style', $custom );

}

add_action( 'wp_enqueue_scripts', 'dental_insight_custom_styles' );


//Sanitizes Fonts
function dental_insight_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
