      ...
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <?php $dental_insight_slider_count = get_theme_mod('dental_insight_slider_count'); ?>
          ...
          if (empty($dental_insight_slide_post) && is_sticky()) {
              $dental_insight_args['post__in'] = get_option('sticky_posts');
          }
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <h2 class="slider-color"><?php the_title();?></h2>
              ...
              <div class="home-btn my-4">
                <a class="py-3 px-4" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('dental_insight_slider_read_more',__('Make an Appointment','dentistry-clinic'))); ?></a>
              </div>
            </div>
          </div>
          <?php $i++; endwhile;
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            if($dental_insight_catData1){ 
              $args = array(
              'post_type' => 'post',
              'category_name' => esc_html($dental_insight_catData1 ,'dentistry-clinic'),
              ...
              <?php $query = new WP_Query( $args );
                ...
                while( $query->have_posts() ) : $query->the_post(); ?>
                  <div class="col-lg-4 col-md-4 wow zoomIn">
                    <div class="box mb-5 text-center px-3 pb-3">
                      <div class="img-box">
