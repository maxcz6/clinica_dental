...
final class Screen_State extends JSON_Serializable_Object {
    ...
    public $enable_unassigned_folder    = true;
	public $colors 						= array();
    ...
    public $schema = array(
        ...
        'enableUnassignedFolder' 	=> 'enable_unassigned_folder',
    ...
    public function __construct( $screen_id, $user_id, $lang = false ) {
        ...
        $this->enable_unassigned_folder = ( bool ) get_option( 'wicked_folders_show_unassigned_folder', true );

		$this->colors = ( array ) get_option( 'wicked_folders_colors', true );
